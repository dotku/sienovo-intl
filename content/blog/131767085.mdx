...
### 多sensor支持：单路硬件isp最多支持4路复用，isp复用情况支持分辨率如下：2路复用：最大分辨率3840x2160，dts对应配置2路rkisp\_vir设备。3路或4路复用：最大分辨率2560x1536，dts对应配置3或4路rkisp\_vir设备。硬件支持最多采集7路sensor：6mipi + 1dvp，多sensor软件通路如下：

**下图是RK3588 camera连接链路示意图，可以支持7路camera。**

## 四、 链路解析：图中：mipi camera2---> csi2\_dphy1 ---> mipi2\_csi2 ---> rkcif\_mipi\_lvds2--->rkcif\_mipi\_lvds2\_sditf --->rkisp0\_vir2
