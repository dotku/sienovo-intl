...
Linux 2.6.36内核优化指南作者：[Ken Wu](http://kenwublog.com/about)
...
磁盘虚拟 10G的SATA磁盘内存分了2G物理内存网卡虚拟 Intel PRO/1000 MT

显卡

128M 显存其他

USB，串口，声卡全关作者是在虚拟机中编译的内核，如果你与作者的运行环境不同，则本文档中的部分描述可能会与你的实际情况有一定出入。
...
APP SPEC测试成绩待测待测红色注释为禁用该选项的理由和解释。
