...
首先需要make一次源代码编辑源码解压生成的apue.2e文件夹下的Make.defines.linux
...
err\_quit跟err\_sys是作者自己定义的错误处理函数,需要单独定义头文件在/usr/include 下新建一个名为myerr.h的文件，拷贝在原书的附录B中头文件到其中。
