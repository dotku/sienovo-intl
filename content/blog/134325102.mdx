...
NPU，0.8Tops@INT8 性能；支持 Caffe/TensorFlow/TFLite/ONNX/PyTorch/Keras/Darknet 主流架构模型的一键转换;
...
按此键上电，USB OTG 切换到固件下载状态；开机键+LED 指示灯开机键+开机指示灯 LED1+运行指示灯 LED2；其它参数电源输入
