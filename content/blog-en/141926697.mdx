---
title: "[Domestic AI Servers] Domestic Alternative to Broadcom PCIe 5.0 Switch Application Examples, Supporting ZS Micro Customization"
date: "2024-09-05"
slug: "141926697"
tags: ["#Server", "#DevOps"]
source: "https://blog.csdn.net/szxinmai/article/details/141926697"
originalTitle: "【国产AI服务器】国产替代博通PCIe 5.0 Switch应用实例，支持众星微定制"
seoTitle: "PCIe 5.0 Switch Applications in Domestic AI Servers | Sienovo"
seoDescription: "Explore PCIe 5.0 switch applications in domestic AI servers with examples and ZS Micro customization to enhance performance."
---

Domestic Alternative to Broadcom PCIe 5.0 Switch Application Examples
...
Note: P2P Requires software support.
...
**In base switch mode (BSw), system software must preallocate resources for empty slots at host boot time.** See the figure below:

![](https://pub-048dcb96257f476697b113fcb5939cb9.r2.dev/blog/141926697/03_322515c90945db0b07701aeb0ff2f4cf.webp)

**The challenge is to reserve PCle resources at configuration so that you can add devices later**. Functionally, synthetic switch (sSw) mode uses management software to create a placeholder endpoint to reserve PCle resources. As shown in the figure below:
...
Notes on PCIe switch Fabric topology:
...
Global ID composition: **The GID is composed of {domain[7:0],ID[15:0]}, where the ID value is a PCIe standard ID composed of {bus[7:0], device[5:0], and function[2:0]}.**
...
This section discusses how to implement different topologies using switches in iSSw mode. It explains how to use GIDs to route TLPs and emphasizes the importance of firmware support.

Examples of fabric port applications:
...
![](https://pub-048dcb96257f476697b113fcb5939cb9.r2.dev/blog/141926697/08_e5812ebf5ecf272129ab16023b47c32.webp)
...
Dual Tree Example as shown in the figure below:
...
Domestic Alternative to Broadcom PCIe 5.0 Switch Application Examples, Shenzhen Xinmai supports ZS Micro PCIe Switch board customization
