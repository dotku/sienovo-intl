...
date: "2021-03-12"
slug: "114708180"
tags: ["#omapl138", "#UnderwaterAcoustic", "#OFDM", "#C6748", "#FPGA"]
...
seoTitle: "OFDM Underwater Acoustic Communication System Design | Sienovo"
seoDescription: "Explore the research and design of an OFDM underwater acoustic communication system based on OMAPL138 DSP+ARM for reliable marine data transmission."
---
...
1. Evaluation Board Overview: Sienovo XM138F-IDK-V3  
...
The XM138F-IDK-V3.0 is an evaluation board designed based on the Sienovo XM138-SP6-SOM system-on-module (SOM), fabricated using a 4-layer, lead-free, immersion gold PCB process. It provides a test platform for the XM138-SP6-SOM, enabling rapid evaluation of the SOM's overall performance.
