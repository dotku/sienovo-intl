...
date: "2021-05-16"
slug: "116897118"
tags: ["#AM5728", "#OPENCL", "#OPENCV", "#OPENMP", "#MulticoreHeterogeneous"]
source: "https://blog.csdn.net/yeyuangen/article/details/116897118"
originalTitle: "基于AM5728的OpenCL例程开发分享"
brandBackfilled: true
seoTitle: "OpenCL on AM5728: Development Guide | Sienovo"
seoDescription: "Learn how to develop OpenCL examples based on the AM5728, enabling efficient parallel programming across heterogeneous systems."
---
---
...
This example is developed using the Sienovo XM5728-IDK-V3 development board.
...
For customer convenience, Sienovo provides verified OpenCL executable files on the CD-ROM at the path `Demo/OpenCL/OpenCL/bin/opencl.tar.gz`. Copy this file to the development board's file system. Navigate to the directory and run the following command to extract:
