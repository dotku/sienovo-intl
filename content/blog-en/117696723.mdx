...
date: "2022-02-21"
slug: "117696723"
tags: ["#AM5728", "#LINUX", "#OpenSource", "#MotionControl", "#DSP+ARM"]
...
seoTitle: "EtherCAT Motion Control with AM5728 Linux | Sienovo"
seoDescription: "Discover Sienovo's open-source EtherCAT motion control solution based on AM5728 Linux, offering high real-time performance and encryption for industrial applications."
---
Sienovo EtherCAT master station with FPGA high real-time performance and encryption support for up to 32 axes
...
XM5728-IDK-V3 is a development board designed by Sienovo based on the TI AM5728 (floating-point dual DSP C66x + dual ARM Cortex-A15) XM5728-SOM system-on-module. It provides a testing platform for evaluating the overall performance of the XM5728-SOM module.
