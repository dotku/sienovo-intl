      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="mailto:collin.liu@sienovo.cn" className="hover:text-white transition-colors">collin.liu@sienovo.cn</a></li>
              <li>
                <a href="https://wa.me/8618718699276" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors inline-flex items-center gap-1.5">
